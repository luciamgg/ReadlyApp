...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2026-04-14 10:03:28',NULL),('diagnostics.include_raw','OFF','2026-04-14 10:03:28',NULL),('ps_thread_trx_info.max_length','65535','2026-04-14 10:03:28',NULL),('statement_performance_analyzer.limit','100','2026-04-14 10:03:28',NULL),('statement_performance_analyzer.view',NULL,'2026-04-14 10:03:28',NULL),('statement_truncate_len','64','2026-04-14 10:03:28',NULL);
...
-- Dump completed on 2026-06-12 17:44:30
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: readly_bd
-- ------------------------------------------------------
-- Server version	8.0.45
...
INSERT INTO `books` VALUES (1,'Don Quijote de la Mancha','Miguel de Cervantes',863,'158977003X','https://www.marcialpons.es/media/img/portadas/2019/4/3/9788491873358.jpg'),(2,'1984','George Orwell',328,NULL,'https://www.planetadelibros.com/usuaris/libros/thumbs/dc7a0bff-acd7-40f8-a3ba-6f6977970acc/d_295_510/portada_1984_george-orwell_202402291343.webp'),(3,'Orgullo y prejuicio','Jane Austen',432,NULL,'https://edicionesinvisibles.com/sites/default/files/orgullo_y_prejuicio.jpg'),(4,'Harry Potter y la piedra filosofal','J.K. Rowling',309,NULL,'https://www.ellibrotecnico.com/imagenes_grandes/9788418/978841817407.JPG'),(5,'Cumbres Borrascosas','Emily Bronte',350,NULL,'https://www.penguinlibros.com/es/7346976-medium_default/cumbres-borrascosas-edicion-especial-limitada-con-cantos-tintados.jpg'),(6,'El señor de los anillos','J.R.R. Tolkien',900,NULL,'https://m.media-amazon.com/images/I/816QLZKwmIL._AC_UF1000,1000_QL80_.jpg'),(7,'Hamnet','William Shakespeare',500,NULL,'https://images.cdn1.buscalibre.com/fit-in/360x360/64/56/64562ef1ef119336dad09c3202bdc021.jpg'),(8,'Cien años de soledad','Gabriel García Márquez',500,NULL,'https://www.rae.es/sites/default/files/portada_cien_anos_de_soledad_0.jpg'),(10,'La sombra del viento','Carlos Ruiz Zafon',500,NULL,NULL),(11,'Los pilares de la tierra','Ken Follet',600,NULL,NULL),(12,'Emma','Jane Austen',300,NULL,NULL);
...
CREATE TABLE `user_books` (
  ...
  CONSTRAINT `user_books_chk_1` CHECK ((`rating` between 1 and 5))
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_books` VALUES (1,1,1,'reading',NULL,NULL,NULL,NULL),(2,1,2,'pending',NULL,NULL,NULL,NULL),(3,1,3,'finished',4,'Fue muy buena lectura',NULL,NULL),(4,1,4,'pending',NULL,NULL,NULL,NULL),(5,1,5,'finished',4,'Me gustó mucho.',NULL,NULL),(6,1,6,'finished',2,'Fue demasiado largo.',NULL,NULL),(7,1,7,'finished',3,'Fue muy emotivo.',NULL,NULL),(8,1,8,'pending',NULL,NULL,NULL,NULL),(10,1,10,'pending',NULL,NULL,NULL,NULL),(11,1,11,'pending',NULL,NULL,NULL,NULL),(12,1,12,'pending',NULL,NULL,NULL,NULL);
...
INSERT INTO `users` VALUES (1,'Jose','jose@gmail.com','hola1234','2026-04-17 11:12:47'),(2,'Lucia','test@test.com','1234','2026-04-27 12:24:01');
